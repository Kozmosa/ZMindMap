...
// Get XSS filter options from configuration
function getXssFilterOptions() {
  // Use configuration if loaded, otherwise use fallback
  return configService.get('xssFilter', {
...
export function xss(content) {
  return filterXSS(content, getXssFilterOptions())
}
/**
 * 获取图片的原始宽高
 * TODO 错误处理 reject
